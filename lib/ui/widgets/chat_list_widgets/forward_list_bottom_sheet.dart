...
class _ForwardBottomSheetState extends State<ForwardBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    void handleOnPressForwardMsg(selectedMsgs) async {
      ...
      if (selectedIds.isNotEmpty) {
        ...
        selectedIds.forEach((selectedId, isGroup) {
          final imageId = "${currentUser['iUserId']}_${selectedId}_${index}_$timestamp";
          ...
          if (chatProvider.selectedImage.isNotEmpty) {
            ...
            selectedMsgs.forEach((msgItem) {
              final msgId = "${currentUser['iUserId']}_${selectedId}_${index}_$timestamp";
              if (isGroup) {
                SocketMessageEvents.sendGroupMessageEvent(
                  receiverChatID: selectedId,
                  senderChatID: currentUser['iUserId'],
    ...
    void handleSelectUsersForForward(bool isSelected, String itemId, bool isGroup) async {
      if (isSelected) {
        ...
        children: [
                ...
                builder: (context, dataListProvider, child) {
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ChatListItem(
                        listTitle: item['name'],
                        listSubTitle: isGroup ? 'Group' : (item['iStatus'] == 1 ? 'Online' : 'Offline'),
                        vProfilePic: item['vProfilePic'],
                        showStatusColor: !isGroup,
                        statusBorderColor: AppColorTheme.lightPrimary,
                        statusColor: isGroup ? Colors.transparent : (item['iStatus'] == 1 ? AppColorTheme.success : AppColorTheme.danger),
                        ...
                        handleOnPressItem: () {
                          handleSelectUsersForForward(isSelected, itemId, isGroup);
          ...
          Padding(
            ...
            child: Button(
              ...
              onPressed: () {
                handleOnPressForwardMsg(widget.isGroupMsgs ? chatProvider.selectedGroupMsgs : chatProvider.selectedMsgs);
              }
            ),
          ),
        ],
